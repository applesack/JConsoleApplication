 ...
 * 框架下一步就会调用你的实现的 {@link #runWithParameter(String, String, String, Interpreter)} 方法, <br>
...
public interface OptionHandler extends Factory {
     ...
     */
    void runWithParameter(String cmd, String optionParameter, String argItems, Interpreter interpreter);
     ...
     * @return 返回原本输入的命令行
     */
    default String getCompleteCommand(String cmdName, String args) {
        if (args.isEmpty())
            return cmdName;
        return cmdName + " " + args;
    }
