...
public class ParserTester {
     ...
     * @return 测试器对象
     */
    public static DelegateTester createTest(ParameterParser parser, String methodName) {
        ...
        if (methods.size() == 1) {
            ...
            return new DelegateTester(parser, methods.pop(), callerInstance);
        }
    ...
    public static class DelegateTester {
        ...
        private DelegateTester(ParameterParser parser , Method method, Object obj) {
         ...
         * @return 构建者
         */
        public DelegateTester addTestCommand(String command) {
        ...
        public void test() {
            try {
                ...
                for (String command : commands) {
                    ...
                    wrapper = parser.parse(meta, command);
                    // 如果解析成功
